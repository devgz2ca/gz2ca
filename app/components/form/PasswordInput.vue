  ...
  <div class="space-y-2">
    ...
    <div class="relative">
      ...
      <button
        ...
        class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
        :disabled="disabled"
      >
